...
export class VideoRoomComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		this.externalConfig.setTheme(Theme.DARK)
	...
	async ngOnInit() {
		...
		this.route.params.subscribe(params => {
            if (params != {}) {
				this.externalConfig.setSessionName(params['room'])	 
            }
        })
	}
	...
	toggleDisplay() {
		// let user = this.remoteUser 
		// this.remoteUser = this.localUser
		this.localDisplayShow = !this.localDisplayShow
		// this.localUser = user 
		// this.isLocalDisplay = !this.isLocalDisplay
		// this.oVLayout.update();
	}
